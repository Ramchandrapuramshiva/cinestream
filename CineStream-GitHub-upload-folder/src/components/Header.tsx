    ...
    <header className="pointer-events-none fixed inset-x-0 top-0 z-40 px-3 pt-3 sm:px-5 sm:pt-4">
      <div className="glass-panel pointer-events-auto mx-auto flex min-h-16 max-w-7xl items-center justify-between gap-3 rounded-[28px] px-3 py-2 shadow-2xl sm:min-h-18 sm:rounded-full sm:px-5 lg:px-6">
        <div className="flex min-w-0 items-center gap-4 lg:gap-7">
          ...
          <a href="#" className="truncate text-lg font-black tracking-tight text-cine-red transition hover:scale-[1.02] sm:text-2xl lg:text-3xl">
            CineStream
          </a>
        ...
        <div className="flex flex-none items-center gap-2">
          ...
          <button
            ...
            className="glass-button grid h-10 w-10 flex-none place-items-center rounded-full text-white transition hover:bg-white/18 sm:hidden"
          ...
          />
          <label className="glass-input flex h-10 w-[58px] flex-none items-center justify-center rounded-full text-xs font-black uppercase text-white/80 sm:hidden">
...
function AuthControl({
  ...
  if (authLoading) {
    return (
      <span className="glass-button grid h-10 w-10 flex-none place-items-center rounded-full text-white/70" aria-label="Restoring session" title="Restoring session">
  ...
  return (
    ...
    >
      <button
        ...
        className="glass-button flex h-10 items-center gap-2 rounded-full py-1 pl-1 pr-2 text-white transition hover:bg-white/18 sm:pr-3"
        aria-expanded={profileOpen}
        aria-label="Profile menu"
      >
        <span className="grid h-8 w-8 place-items-center overflow-hidden rounded-full bg-cine-red text-xs font-black text-white shadow-glow">
