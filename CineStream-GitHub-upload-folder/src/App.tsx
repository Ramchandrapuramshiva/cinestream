  ...
  return (
    <div className="cinestream-intro fixed inset-0 z-[80] grid place-items-center bg-black text-white" aria-label="CineStream opening animation">
      ...
      <div className="cinestream-intro__content">
        <div className="cinestream-intro__mark">
          <svg viewBox="0 0 160 160" aria-hidden="true" className="cinestream-intro__logo">
            <defs>
              <linearGradient id="introLogoShine" x1="42" x2="118" y1="30" y2="130" gradientUnits="userSpaceOnUse">
                <stop stopColor="#ffffff" />
                <stop offset="0.45" stopColor="#fff4f5" />
                <stop offset="1" stopColor="#ffc4c8" />
              </linearGradient>
            </defs>
            <path
              d="M112 43.5C102.8 34.4 91 29.5 77 29.5C48.2 29.5 27.5 50.2 27.5 80C27.5 109.8 48.2 130.5 77 130.5C91.3 130.5 103.6 125.4 113 115.7"
              fill="none"
              stroke="url(#introLogoShine)"
              strokeLinecap="round"
